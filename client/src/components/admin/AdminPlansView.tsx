    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="h-auto px-3 py-1.5 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-700"
        >
        ...
        <div className="bg-white p-4 rounded-lg shadow space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              onClick={submit}
              disabled={saving}
              className="h-auto px-3 py-1.5 bg-green-600 text-white rounded-md text-sm disabled:opacity-50"
            >
          ...
          <tbody className="divide-y divide-gray-200">
            {plans.map((plan) => (
              <tr key={plan.id}>
                ...
                <td className="px-4 py-3">
                  <FeatureToggle planId={plan.id} onToggleFeature={onToggleFeature} />
                </td>
              </tr>
            ))}
            {hasMore && (
    ...
    <div className="inline-flex items-center gap-1">
      <div className="w-28">
        <Input
          ...
          className="w-full border rounded px-1.5 py-1 text-xs h-auto"
        />
      </div>
      <Button
        variant="ghost"
        ...
        className="h-auto p-0 hover:bg-transparent text-blue-600 text-xs hover:text-blue-800"
      >
        enable
      </Button>
    </div>
